...
uint32 id_prep = startSection(section_prep,1::uint64);
    ...
    string tbl = "reduced_traffic"; // Table name
    string tbl_party_A="reduced_traffic_party_A";
    string tbl_party_B="reduced_traffic_party_B";
    ...
    */
    ...
    uint no_of_chunks = 70000; // 1,2,4,5,10,20,100
