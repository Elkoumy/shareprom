...
input_file=r"C:\Gamal Elkoumy\PhD\OneDrive - Tartu Ülikool\Secure MPC\Business Process Mining SourceCode\Github\SecureMPCBPM\data_and_preprocessing\Road_Traffic_Fine_Management_Process_3_columns.csv"
...
party_A=data[~data.event.isin(['00000000001','00000000100', '00000010000','00000001000','00000000010'])]
party_B=data[data.event.isin(['00000000001','00000000100', '00000010000','00000001000','00000000010'])]
...
data.to_csv(output_dir+"\\"+"Road_Traffic_Fine_Management_Process_MPC.csv", index=0)
party_A.to_csv(output_dir+"\\"+"party_A_Road_Traffic_Fine_Management_Process_MPC.csv",index=0)
party_B.to_csv(output_dir+"\\"+"party_B_Road_Traffic_Fine_Management_Process_MPC.csv", index=0)     