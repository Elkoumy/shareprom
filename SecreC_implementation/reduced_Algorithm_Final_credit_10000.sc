...
uint32 id_prep = startSection(section_prep,1::uint64);
    ...
    string tbl = "reduced_credit"; // Table name
    string tbl_party_A="reduced_credit_party_A";
    string tbl_party_B="reduced_credit_party_B";
    ...
    */
    uint unique_events= 8;
    uint event_per_case_A = 7;
    uint event_per_case_B = 7;
    ...
    uint no_of_chunks = 10000; // 1,2,4,5,10,20,100
