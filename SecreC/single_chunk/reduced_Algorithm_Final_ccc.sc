...
uint32 id_prep = startSection(section_prep,1::uint64);
    ...
    string tbl_party_A="CCC19_party_A";
    string tbl_party_B="CCC19_party_B";
    ...
    print("************ Reading party B the events **************");
    ...
    */
    uint unique_events= 29;
    uint event_per_case_A = 58;
    uint event_per_case_B = 60;
