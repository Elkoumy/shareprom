...
uint32 id_prep = startSection(section_prep,1::uint64);
    ...
    string tbl = "reduced_bpi"; // Table name
    string tbl_party_A="reduced_bpi_party_A";
    string tbl_party_B="reduced_bpi_party_B";
...
print("************ Reading party B**************");
    ...
    print("************ Finish Reading the events **************");
    /*
    ...
    */
    ...
    uint unique_events= 26;
    uint event_per_case_A = 173;
    uint event_per_case_B = 65;
    ...
    uint no_of_chunks = 1000; // 1,2,4,5,10,20,100
