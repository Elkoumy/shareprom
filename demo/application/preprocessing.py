...
# preprocessing
def preprocessing(input_dir,output_dir,file_name):
    ...
    # print(model)
    text_file = open(os.path.join(output_dir,name+ "_model_party_A.xml"), "w")
    ...
    # print(model)
    text_file = open(os.path.join(output_dir,name+ "_model_party_B.xml"), "w")
    text_file.write(model)
    text_file.close()
